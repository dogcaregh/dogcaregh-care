...
export const AREA_COORDS: Record<string, [number, number]> = {
  ...
  "Jamestown":           [5.5444, -0.2097],
  "Kanda":               [5.5844, -0.1933],
  "Kaneshie":            [5.5617, -0.2285],
  "Kasoa":               [5.5333, -0.4167],
  "Katamanso":           [5.7292, -0.0667],
  "Klagon":              [5.6214, -0.0544],
  "Kokrobite":           [5.5167, -0.3833],
  "Kokomlemle":          [5.5750, -0.2078],
  "Korle Bu":            [5.5428, -0.2239],
  "Kotobabi":            [5.5814, -0.2048],
  "Kpone":               [5.6918,  0.0547],
  "Kpeshie":             [5.5939, -0.1319],
  ...
  "Mataheko":            [5.5561, -0.2878],
  "McCarthy Hill":       [5.5561, -0.2750],
  "Michel Camp":         [5.7183,  0.0528],
  "Nanakrom":            [5.6961, -0.1548],
  "Nima":                [5.5775, -0.2126],
  "Nmai Dzorn":          [5.7028, -0.1500],
